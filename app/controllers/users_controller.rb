class UsersController < ApplicationController
  ...
  def create
    ...
    if @user.save
      ...
      redirect_to root_path, notice: "An email has been sent to your account. Please click lthe ink in the email to verify address and complete your registration."
    else
